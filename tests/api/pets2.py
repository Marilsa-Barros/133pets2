...
def ler_dados_csv():
    ...
    nome_arquivo = 'C:\\Users\\Tata\\PycharmProjects\\133pets2\\vendors\\csv\\pets_positivo.csv'
    try:
...
def testar_incluir_pet():
    ...
    resultado_obtido = requests.post(url=base_url + '/pet',
                                     data=open('C:\\Users\\Tata\\PycharmProjects\\133pets2\\vendors\\json\\pet1.json',
                                               'rb'),
                                     headers=headers
                                     )
    # Valida
...
def testar_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=f'{base_url}/pet',
        data=open('C:\\Users\\Tata\\PycharmProjects\\133pets2\\vendors\\json\\pet2.json', 'rb'),
        headers=headers
    )
